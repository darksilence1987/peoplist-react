...
function CreateNewCandidateModal({ showModal, toggleModal, onFormSubmit }) {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    onFormSubmit({ fullName, email, phoneNumber, status });
    toggleModal();
  };
...
export default CreateNewCandidateModal;
